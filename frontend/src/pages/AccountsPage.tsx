...
export default function AccountsPage() {
  ...
  return (
    <>
        ...
        {/* Import PDF Modal */}
        {importModalAccId && (
          <div className="modal-overlay" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', overflowY: 'auto', padding: '0.75rem' }}>
            <div className="glass-panel" style={{ width: '98vw', maxWidth: '98vw', padding: '1.25rem', position: 'relative' }}>
